...
import 'package:Hitch/screens/driver-screens/offer-ride/dropoff_location_page.dart';
...
class _PickupLocationPageState extends State<PickupLocationPage> {
  ...
  void _onPlaceSelected(PlaceSuggestion suggestion) {
    Provider.of<TripRequestProvider>(context, listen: false).setDeparture(suggestion);
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => const DropoffLocationPage()),
    );
  }

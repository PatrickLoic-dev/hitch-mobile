...
import 'package:Hitch/components/button.dart'; // IMPORTANT : Import de votre bouton personnalisé
import 'package:Hitch/models/place_suggestion.dart';
import 'package:Hitch/screens/rider-screens/home/trips-request/select_date_page.dart'; // IMPORTANT : Import de la page de date
...
class _SearchDestinationPageState extends State<SearchDestinationPage> {
  ...
  void _navigateToDatePage() {
    if (_selectedPlace != null && mounted) {
      Provider.of<TripRequestProvider>(context, listen: false).setDestination(_selectedPlace!);

      print('Destination confirmée et stockée : ${_selectedPlace!.mainText}');
  ...
  Future<void> _handleUseMyLocation() async {
    ...
    try {
      ...
      if (placemarks.isNotEmpty && mounted) {
        ...
        // Au lieu de naviguer, on sélectionne le lieu.
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Where are you heading to?', style: TextStyle(fontFamily: 'Jokker', fontSize: 24, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 16),
            ...
            if (_selectedPlace != null)
              Padding(
                ...
                child: SizedBox(
                  ...
                  // Utilisation de votre composant personnalisé
                  child: Button(
                    onPressed: _navigateToDatePage,
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _buildSuggestionItem(
          ...
          onTap: () => _onPlaceSelected(suggestion), // Appelle la logique de sélection
        );
      },
    );
  }

  // Construit un élément de la liste (inchangé)

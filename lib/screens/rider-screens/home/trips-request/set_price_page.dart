...
import 'package:Hitch/screens/rider-screens/home/trips-request/ride_summary_page.dart';
...
class _SetPricePageState extends State<SetPricePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final String tripInfo = "${formatter.format(tripProvider.dateTime!)} • ${tripProvider.seatCount} Seats";
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Recommended price: XAF 500 - XAF 1000',
